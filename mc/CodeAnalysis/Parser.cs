...
namespace Minsk.CodeAnalysis
{
    ...
    internal class Parser
    {
        ...
        {
            Int64 startTicks = Log.PARSER($"Enter/Exit", Common.LOG_CATEGORY);
        ...
        private ExpressionSyntax ParseTerm()
        {
            ...
            Log.PARSER($"Exit: left: {left}", Common.LOG_CATEGORY, startTicks);

            return left;
        }

        // NOTE(crhodes)
        // Handle Multiplicaion and Division
        ...
        private ExpressionSyntax ParsePrimaryExpression()
        {
            ...
            Log.PARSER($"Exit: new NumberExpressionSyntax", Common.LOG_CATEGORY, startTicks);
